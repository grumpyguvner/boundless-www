...
<div class="row">
	<?php  if( strlen($title)>0){ ?><h5 class="large-12 columns"><?php echo $title?></h5><?php  } ?>
	...
	<div class="large-2 columns no-padding">
		<input name="submit" type="submit" value="<?php echo $buttonText?>" class="ccm-search-block-submit button small prefix" />
	</div>
</div>	
<?php  
	...
	<?php  }else{ ?>
		...
		<?php  foreach($results as $r) { 
			...
			<p class="searchResult">
				<h6><a href="<?php echo $r->getPath()?>"><?php echo $r->getName()?></a></h6>
					<p>
