<html xml:lang="en" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <body>
		...
		<div id="scrollable">
			<div id="take-me-home" class="section-slide first-section">
				<div class="container">
			...
			<div id="about" class="section about">
				<div class="container">
					...
					<div class="column-455 m-top-50">
                                        ...
                                        <div class="clear"></div>
                                        <div class="column-300 m-left-170 m-top-55 m-right-40">
						<?php
                                                $a = new Area('column-300 m-left-170 m-top-55 m-top-40');
                                                $a->display($c);
                                                ?>
                                        </div>
					<div class="column-300 m-top-55 m-right-40">
                                                <?php
                                                $a = new Area('column-300 m-top-55 m-right-40');
                                                $a->display($c);
                                                ?>
                                        </div>
					<!--div class="column-300 m-top-55">
                                        ...
                                        <div class="column-300 m-top-55 m-right-40">
						<?php
                                                $a = new Area('column-300 m-left-55 m-top-40');
                                                $a->display($c);
                                                ?>
                                        </div>
					<div class="column-300 m-top-55 m-right-40">
                                                <?php
                                                $a = new Area('column-300_1 m-top-55 m-right-40');
                                                $a->display($c);
                                                ?>
                                        </div>
					<div class="column-300 m-top-55">
                                                <?php 
                                                $a = new Area('column-300 m-top-55');
                                                $a->display($c); 
                                                ?>
                                        </div>
			...
			<div id="services" class="section services">
				<div class="container">
					...
					<div class="clear"></div>
                                        <div class="column-280 m-top-50">
						<?php
                                                $a = new Area('column-280 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
					<div class="column-280 m-left-70 m-top-50">
						<?php
                                                $a = new Area('column-280 m-left-70 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
                                        <div class="column-280 m-left-70 m-top-50">
						<?php
                                                $a = new Area('column-280_1 m-left-70 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
                                        <div class="column-280 m-top-50">
						<?php
                                                $a = new Area('column-280_1 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
					<div class="column-280 m-left-70 m-top-50">
						<?php
                                                $a = new Area('column-280_2 m-left-70 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
                                        <div class="column-280 m-left-70 m-top-50">
						<?php
                                                $a = new Area('column-280_3 m-left-70 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
					<div class="column-980 m-top-50">
						<?php
                                                $a = new Area('column-980 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
				</div>       
					...
					<div class="subheader">
						<?php
                                                $a = new Area('subheader5');
                                                $a->display($c);
                                                ?>
					</div> 
					<div class="column-640 m-top-50">
						<?php
                                                $a = new Area('column-640_i m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
					<div class="column-300 m-left-40 m-top-50">
						<?php
                                                $a = new Area('column-300_i m-left-40 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
					<div class="clear"></div>
                                        <div class="column-280 m-top-50">
						<?php
                                                $a = new Area('column-280_i m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
					<div class="column-280 m-left-70 m-top-50">
						<?php
                                                $a = new Area('column-280_i1 m-left-70 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
                                        <div class="column-280 m-left-70 m-top-50">
						<?php
                                                $a = new Area('column-280_i2 m-left-70 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
                                        <div class="column-280 m-top-50">
						<?php
                                                $a = new Area('column-280_i1 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
					<div class="column-280 m-left-70 m-top-50">
						<?php
                                                $a = new Area('column-280_i3 m-left-70 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
                                        <div class="column-280 m-left-70 m-top-50">
						<?php
                                                $a = new Area('column-280_i4 m-left-70 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
					<div class="column-980 m-top-50">
						<?php
                                                $a = new Area('column-980_i m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
				</div>       
					...
					<div class="subheader">
						<?php
                                                $a = new Area('subheader7');
                                                $a->display($c);
                                                ?>
					</div> 
					<div class="column-640 m-top-50">
						<?php
                                                $a = new Area('column-640_p m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
					<div class="column-300 m-left-40 m-top-50">
						<?php
                                                $a = new Area('column-300_p m-left-40 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
					<div class="clear"></div>
                                        <div class="column-280 m-top-50">
						<?php
                                                $a = new Area('column-280_p m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
					<div class="column-280 m-left-70 m-top-50">
						<?php
                                                $a = new Area('column-280_p1 m-left-70 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
                                        <div class="column-280 m-left-70 m-top-50">
						<?php
                                                $a = new Area('column-280_p2 m-left-70 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
                                        <div class="column-280 m-top-50">
						<?php
                                                $a = new Area('column-280_p1 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
					<div class="column-280 m-left-70 m-top-50">
						<?php
                                                $a = new Area('column-280_p3 m-left-70 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
                                        <div class="column-280 m-left-70 m-top-50">
						<?php
                                                $a = new Area('column-280_p4 m-left-70 m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
					<div class="column-980 m-top-50">
						<?php
                                                $a = new Area('column-980_p m-top-50');
                                                $a->display($c);
                                                ?>
					</div>
				</div>       
				...
				<div class="container">
					...
					<div class="subheader">
						<?php
                                        ...
                                        <div class="column-340  m-top-50 m-right-115">
						<?php
                                                $a = new Area('column-340_6 m-top-50 m-right-115');
                                                $a->display($c);
                                                ?>
					</div>
					...
					<div class="column-525 m-top-50">
						<?php
                                    ...
                                    <div class="column-340  m-top-l322 m-right-115 contact-form contact-us-x">
						<?php
